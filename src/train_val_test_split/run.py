#!/usr/bin/env python
"""
This script splits the provided dataframe in train and test sets
...
def go(args):
    ...
    # fetch input artifact from wandb. This will also note that this script is using this
    ...
    # Save to output files and log to wandb
