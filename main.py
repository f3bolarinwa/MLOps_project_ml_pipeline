...
def go(config: DictConfig):
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        if "download" in active_steps:
            # this component Extracts file from a git repo and load to W&B.
        ...
        if "basic_cleaning" in active_steps:
            # this component Performs basic ETL on output of "download" component.
        ...
        if "data_check" in active_steps:
            # this component Implements basic data checks and validation using pytest on output of "basic_cleaning" component
            # Note that MLflow project environment for this component is defined in the local machine
            _ = mlflow.run(
        ...
        if "data_split" in active_steps:
            # this component splits output of "data_check" component to train-test datasets.
        ...
        if "train_random_forest" in active_steps:
            #this component trains a random forest model on train_data from "data_slit" component.
            # Note that MLflow project environment for this component is defined in the local machine
        ...
        if "test_regression_model" in active_steps:
            ...
            #i needed to promote a model export to "prod" in W&B before running the component.
            # Note that MLflow project environment for this component is defined in the local machine
